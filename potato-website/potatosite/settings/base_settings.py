"""
Django COMMON settings for potatosite project.
...
# These values are overridden by each environment file
# DEBUG = True
# ALLOWED_HOSTS = []
# DATABASES = { ... }
...
WSGI_APPLICATION = 'potatosite.wsgi.application'
